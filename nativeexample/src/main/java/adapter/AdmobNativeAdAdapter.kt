...
import com.example.nativeexample.nativetemplates.NativeTemplateStyle
import com.example.nativeexample.nativetemplates.TemplateView
...
class AdmobNativeAdAdapter private constructor(private val mParam: Param) :
    ...
    private class AdViewHolder internal constructor(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            templatesmall = view.findViewById(R.id.templateSmall)
            templatecustom = view.findViewById(R.id.templateCustom)
            templatemedium = view.findViewById(R.id.templateMedium)
            loaded = false
