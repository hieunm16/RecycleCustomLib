...
package com.example.nativeexample.nativetemplates;
...
public class TemplateView extends FrameLayout {
  ...
  public String getTemplateTypeName() {
    if (templateType == R.layout.custom_small_template_view) {
    ...
    try {
      templateType =
          attributes.getResourceId(
              R.styleable.TemplateView_template_type, R.layout.custom_small_template_view);
    } finally {
      attributes.recycle();
    }
